...
namespace HafezLibrary.Controllers
{
    public static class DbCache
    {
        ...
        public static List<PersonalDuaModel> PersonalDuas { get; private set; } =
            PersonalDuaController.GetAllPersonalDuas();

        public static IEnumerable<PersonalDuaListModel> PersonalDuaLists { get; private set; } =
            PersonalDuaListController.GetAllPersonalDuaList();
